...
| 编号 | 文档 | 说明 |
|------|------|------|
| 01 | [快速上手指南](01_GETTING_STARTED_快速上手.md) | 硬件需求、环境搭建、烧录步骤、首次使用、常见问题 |
| 02 | [系统架构](02_ARCHITECTURE_系统架构.md) | 模块关系图、数据流、初始化流程、主循环调度 |
| 03 | [BLE 键盘模块](03_BLE_KEYBOARD_BLE键盘模块.md) | HID 报告格式、类结构、连接生命周期、安全配对 |
...
|-----|----------|-------------|
| 01 | [Getting Started Guide](01_GETTING_STARTED_快速上手.md) | Hardware requirements, setup, flashing, first use, troubleshooting |
| 02 | [System Architecture](02_ARCHITECTURE_系统架构.md) | Module diagram, data flow, initialization, main loop |
| 03 | [BLE Keyboard Module](03_BLE_KEYBOARD_BLE键盘模块.md) | HID report format, class structure, connection lifecycle, security pairing |
